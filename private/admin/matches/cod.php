...
// Try different possible game names for COD
$possible_names = ['Call of Duty Mobile', 'COD', 'Call of Duty', 'CODM'];
$matches = [];
foreach ($possible_names as $name) {
    $matches = fetchMatches($supabase, $name);
    if (!empty($matches)) {
        error_log("Found COD matches with game name: " . $name);
        break;
    }
}
...
<script src="../assets/js/matches/cod.js"></script>
<script>
